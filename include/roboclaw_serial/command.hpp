...
namespace roboclaw_serial
{
    ...
    struct Request
    {
        ...
        static bool canRead()
        {
            return ReadCommand != Command::NONE;
        }

        static bool canWrite()
        {
            return WriteCommand != Command::NONE;
        }
    ...
    using MainBatteryVoltageCutoff = Request<Command::READ_MAIN_BATT_VOLT_SET, Command::SET_MAIN_BATT_VOLT, uint8_t, uint8_t>;
    ...
    using VelocityPIDConstantsM1 = Request<Command::READ_M1_VEL_PID_CONST,
                                           Command::SET_M1_VEL_PID_CONST,
                                           int32_t, int32_t, int32_t, int32_t>;

    using VelocityPIDConstantsM2 = Request<Command::READ_M2_VEL_PID_CONST,
                                           Command::SET_M2_VEL_PID_CONST,
                                           int32_t, int32_t, int32_t, int32_t>;
